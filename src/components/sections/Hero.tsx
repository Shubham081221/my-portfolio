      ...
      <div className="max-w-5xl mx-auto px-6 py-24 w-full">
        ...
        <div className="max-w-2xl">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-gray-200 bg-gray-50 mb-8">
            ...
            <span className="text-xs text-gray-600 font-medium">Available for opportunities</span>
          </div>
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-10 max-w-xl">
            I build scalable, user-focused web applications using React, Node.js, 
            and modern tooling. Passionate about clean code, great UI, and 
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <Link
              href="/projects"
              className="px-6 py-3 rounded-lg bg-gray-900 text-white text-sm font-medium hover:bg-gray-700 transition-colors duration-200"
            >
              View Projects
            </Link>
            <Link
